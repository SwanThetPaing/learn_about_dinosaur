<x-admin-layout>
    ...
    <h3 class="my-3 text-center text-white">Blog Create Form</h3>
        <x-card-wrapper style="width: 434px; height: 1400px; margin: 0 auto; background-color: black;">
            <form enctype="multipart/form-data" action="/admin/blogs/store" method="post" style="width: 400px; height: 600px;">
            @csrf
